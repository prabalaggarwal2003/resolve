...
export function getDefaultHomeDashboardLayout(): HomeDashboardLayout {
  return {
    ...
    widgets: [
      ...
      { id: 'h6', kind: 'attention', title: 'Attention Required', size: 'large', filters: {}, filterFields: [], order: 4, visible: true, sizeLocked: false },
      { id: 'h7', kind: 'activity', title: 'Recent Activity', size: 'large', filters: {}, filterFields: [], order: 5, visible: true, sizeLocked: false },
      { id: 'h8', kind: 'chart', metric: 'by_group', title: 'Assets by Group', size: 'medium', filters: {}, filterFields: [], order: 6, visible: true, sizeLocked: false },
      { id: 'h9', kind: 'chart', metric: 'by_status', title: 'Assets by Status', size: 'medium', filters: {}, filterFields: [], order: 7, visible: true, sizeLocked: false },
      { id: 'h10', kind: 'chart', metric: 'by_location', title: 'Assets by Location', size: 'medium', filters: {}, filterFields: [], order: 8, visible: true, sizeLocked: false },
      { id: 'h11', kind: 'warranty_overview', title: 'Warranty Overview', size: 'medium', filters: {}, filterFields: [], order: 9, visible: true, sizeLocked: false },
      { id: 'h12', kind: 'financial', title: 'Financial Snapshot', size: 'medium', filters: {}, filterFields: [], order: 10, visible: true, sizeLocked: false },
      { id: 'h13', kind: 'latest_assets', title: 'Latest Assets', size: 'medium', filters: {}, filterFields: [], order: 11, visible: true, sizeLocked: false },
      { id: 'h14', kind: 'performance', title: 'Performance', size: 'medium', filters: {}, filterFields: [], order: 12, visible: true, sizeLocked: false },
      { id: 'h15', kind: 'notifications', title: 'Notifications', size: 'medium', filters: {}, filterFields: [], order: 13, visible: true, sizeLocked: false },
      { id: 'h16', kind: 'system_status', title: 'System Status', size: 'medium', filters: {}, filterFields: [], order: 14, visible: true, sizeLocked: false },
    ],
  };
}
...
export const HOME_DASHBOARD_TEMPLATES: HomeDashboardTemplate[] = [
  {
    ...
    layout: base([
      ...
      { id: 'ex5', kind: 'attention', title: 'Attention Required', size: 'large', filters: {}, filterFields: [], order: 3, visible: true, sizeLocked: false },
      { id: 'ex6', kind: 'financial', title: 'Financial Snapshot', size: 'medium', filters: {}, filterFields: [], order: 4, visible: true, sizeLocked: false },
      { id: 'ex7', kind: 'chart', metric: 'by_group', title: 'Assets by Group', size: 'medium', filters: {}, filterFields: [], order: 5, visible: true, sizeLocked: false },
      { id: 'ex8', kind: 'performance', title: 'Performance', size: 'medium', filters: {}, filterFields: [], order: 6, visible: true, sizeLocked: false },
    ]),
  },
  {
    id: 'operations',
  ...
  },
  {
    ...
    layout: base([
      ...
      { id: 'fn3', kind: 'financial', title: 'Financial Snapshot', size: 'large', filters: {}, filterFields: [], order: 1, visible: true, sizeLocked: false },
      { id: 'fn4', kind: 'warranty_overview', title: 'Warranty Overview', size: 'medium', filters: {}, filterFields: [], order: 2, visible: true, sizeLocked: false },
      { id: 'fn5', kind: 'chart', metric: 'by_group', title: 'Assets by Group', size: 'medium', filters: {}, filterFields: [], order: 3, visible: true, sizeLocked: false },
      { id: 'fn6', kind: 'kpi', metric: 'warranty_expiring', title: 'Warranty Expiring', size: 'small', filters: {}, filterFields: [], order: 4, visible: true, sizeLocked: false },
    ]),
  },
  {
    id: 'maintenance',
    ...
    layout: base([
      ...
      { id: 'mt4', kind: 'attention', title: 'Attention Required', size: 'large', filters: {}, filterFields: [], order: 2, visible: true, sizeLocked: false },
      { id: 'mt5', kind: 'activity', title: 'Recent Activity', size: 'medium', filters: {}, filterFields: [], order: 3, visible: true, sizeLocked: false },
      { id: 'mt6', kind: 'notifications', title: 'Notifications', size: 'medium', filters: {}, filterFields: [], order: 4, visible: true, sizeLocked: false },
      { id: 'mt7', kind: 'performance', title: 'Performance', size: 'medium', filters: {}, filterFields: [], order: 5, visible: true, sizeLocked: false },
    ]),
  },
  {
    id: 'it',
    name: 'IT Dashboard',
    description: 'IT asset inventory, status, and system overview',
    layout: base([
