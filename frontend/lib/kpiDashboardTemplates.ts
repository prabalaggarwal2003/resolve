...
export function getDefaultKpiDashboardLayout(): KpiDashboardLayout {
  return {
    ...
    widgets: [
      ...
      { id: 'k8', kind: 'quick', title: 'Upcoming Maintenance', quickType: 'upcoming_maintenance', filters: {}, filterFields: [], order: 7, colSpan: 6, rowSpan: 3, sizeLocked: false },
    ],
  };
}
...
export const KPI_DASHBOARD_TEMPLATES: KpiDashboardTemplate[] = [
  {
    ...
    layout: base([
      ...
      { id: 'e7', kind: 'quick', title: 'Warranty Expiring Soon', quickType: 'warranty_expiring_soon', filters: {}, filterFields: [], order: 6, colSpan: 12, rowSpan: 3 },
    ]),
  },
  {
    id: 'it_manager',
    name: 'IT Manager Dashboard',
    description: 'IT asset inventory, issues, and utilization',
    layout: base([
      ...
      { id: 'i3', kind: 'metric', title: 'Utilization %', metric: 'utilization_pct', chartType: 'gauge', filters: {}, filterFields: [], order: 2, colSpan: 4, rowSpan: 2 },
      { id: 'i4', kind: 'quick', title: 'Latest Issues', quickType: 'latest_issues', filters: {}, filterFields: [], order: 3, colSpan: 6, rowSpan: 3 },
      { id: 'i5', kind: 'quick', title: 'Upcoming Maintenance', quickType: 'upcoming_maintenance', filters: {}, filterFields: [], order: 4, colSpan: 6, rowSpan: 3 },
